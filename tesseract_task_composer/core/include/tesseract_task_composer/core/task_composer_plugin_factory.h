...
public:
  ...
  // /**
  //  * @brief Add a profile plugin to the manager
  ...
  //  * @param section_name The task section name
  //  * @param profile_name The profile name
  //  * @param plugin_info The plugin information
  //  */
  // void addTaskComposerProfilePlugin(const std::string& task_ns,
  ...
  //  * @return A map of plugins
  //  */
  // PluginInfoMap getTaskComposerProfilePlugins(const std::string& task_ns, const std::string& section_name) const;
  ...
  //  * @param profile_name The profile name
  //  */
  // void removeTaskComposerProfilePlugin(const std::string& task_ns,
  //                                      const std::string& section_name,
  //                                      const std::string& profile_name);
  ...
  //  * @param profile_name The profile name
  //  */
  // void setDefaultTaskComposerProfilePlugin(const std::string& task_ns,
  //                                          const std::string& section_name,
  //                                          const std::string& profile_name);
  ...
  //  */
  // std::string getDefaultTaskComposerProfilePlugin(const std::string& task_ns, const std::string& section_name) const;
  ...
  //  */
  // std::unique_ptr<tesseract_common::Profile> createTaskComposerProfile(const std::string& task_ns,
  //                                                                      const std::string& section_name,
  ...
  // createTaskComposerProfile(const std::string& task_ns,
  //                           const std::string& section_name,
  //                           const std::string& profile_name,
  //                           const tesseract_common::PluginInfo& plugin_info) const;
